...
import { idlFactory } from './my_motoko_canister.did.js';
export { idlFactory } from './my_motoko_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MY_MOTOKO_CANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./my_motoko_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the my_motoko_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./my_motoko_canister.did.js")._SERVICE>}
 */
export const my_motoko_canister = createActor(canisterId);
